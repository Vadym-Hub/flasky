...
@api.route('/comments/')
def get_comments():
    """Обработывает GET-запрос для всех комментариев"""
...
def get_comment(id):
    """Обрабатывает GET-запрос для одного комментария"""
...
def get_post_comments(id):
    """Обработывает GET-запрос комментариев к посту"""
...
def new_post_comment(id):
    """Обработывает POST-запрос для комментария з посту"""
    post = Post.query.get_or_404(id)
